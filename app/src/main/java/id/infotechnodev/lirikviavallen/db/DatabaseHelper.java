package id.infotechnodev.lirikviavallen.db;
...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static String DB_NAME = "viavallen.db";
	private static String DB_PATH = "/data/data/id.infotechnodev.lirikviavallen/databases/" + DB_NAME;
