...
import id.infotechnodev.lirikviavallen.transposer.Chord;
import id.infotechnodev.lirikviavallen.transposer.Chord.Note;
import id.infotechnodev.lirikviavallen.transposer.Chord.NoteMajor;
...
public class TransposeDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.transpose_ok).setOnClickListener(new View.OnClickListener() {
			@Override
		...
		findViewById(R.id.transpose_cancel)
